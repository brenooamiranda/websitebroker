    ...
    <div class="content-area">
        <main>
            ...
            <section class="services">
                <div class="container">
                    <h1><?php _e( 'Our Services', 'wpseguros' ); ?></h1>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="news col-md-8">
                            <div class="container">
                                <h1><?php _e( 'Latest News', 'wpseguros' ); ?></h1>
                                <div class="row">
                                    <?php

                                    $featured = new WP_Query( 'post_type=post&posts_per_page=1&cat=11,9' );
